...
(function($){
    ...
    $.jSlots = function(el, options){
        ...
        base.init = function() {
            //$('body').append('<audio id="audioSlot" controls hidden><source src="../rs/sound/slot.mp3" type="audio/mpeg"></audio>'); 
        ...
        $.jSlots.defaultOptions = {
            ...
            start : true,
            sound : true,
            endNumbers : [0,0,0,0,0],
            numberSets : [1,10,9,8,7,6,5,4,3,2]
        };
        ...
        base.getEndNumber = function(idx) {
            var liary = base.options.numberSets;
            var endSet = parseInt(base.options.endNumbers[idx],10)
            var endnum = liary[endSet];
            return endnum;
        };
        // --------------------------------------------------------------------- //
        // VARS
        ...
        base.Slot.prototype = {
            ...
            spinEm : function() {
                ...
                var that = this;
                if(base.options.endNumbers.length == base.index)
                base.index = 0;
                that.$el
            ...
            finish : function() {
                ...
                //var idx = that.$el.index(that);   
                var endNum = base.getEndNumber(base.index);
                base.index++;
        ...
        base.checkWinner = function(endNum, slot) {
            ...
            if (base.doneCount === base.options.number) {
                ...
                if ( $.isFunction(base.options.onFinish) ) {
                    base.options.onFinish();
                }
            }
        };
