<?php
/* Smarty version 3.1.30, created on 2017-11-24 11:08:56
  from "C:\Program Files (x86)\EasyPHP-Devserver-16.1\eds-www\mmc\templates\mmc.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a178d4891edc6_80363732',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4a24371f77093a1f0b3f747b79381b07ddbc06d6' => 
    array (
      0 => 'C:\\Program Files (x86)\\EasyPHP-Devserver-16.1\\eds-www\\mmc\\templates\\mmc.tpl',
      1 => 1511492934,
      2 => 'file',
    ),
  ),
...
function content_5a178d4891edc6_80363732 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<?php echo '<script'; ?>
 type="text/javascript" src="../rs/js/jquery.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript" src="/mmc/js/audiojs/audio.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 type="text/javascript" src="../rs/js/jquery-ui.min.js"><?php echo '</script'; ?>
>
...
<!--mmc-->
    ...
    <!--開講頭-->
      <div class="header">
			...
			<!--獎池-->
			<div id="lott_bar" style="display:none ;margin-left:333px">
				<div id="box"></div>
			...
			<div id="lott_rs" style="margin-left:333px" >
				<div class="box">		
					<ul class="inbox">
						<li><img src="./images/mmc_9.png"></li>	
					</ul>
			...
			<div class="tab_content">
				<table width="100%" class="option" border="0" cellpadding="1" cellspacing="0">
					...
					<tr>
						...
						<td width="200">
						<p class="left">输入倍数：</p>   <p class="switch_options rating">
							<span class="switch_enable " id="time_add"> <img src="../images/keno/plus.png">   </span>
							<input type="text" name="lt_sel_times" id="lt_sel_times" class="input left textfield6 numeric" value="1" maxlength="4" size="4" onkeyup="comBetMoney()">
							<span class="switch_enable" id="time_reduce"><img src="../images/keno/minus.png">  </span>
						</p>
						</td>
...
<?php echo '<script'; ?>
 type="text/javascript" src="/rs/js/jquery.jSlots.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
